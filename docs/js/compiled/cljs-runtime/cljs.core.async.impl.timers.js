...
var i_33707 = (self__.level + (1));
while(true){
if((i_33707 <= (new_level + (1)))){
(update[i_33707] = self__.header);

var G__33709 = (i_33707 + (1));
i_33707 = G__33709;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33711 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33711[i]));
} else {
x__$2.forward.push((((i < links_33711.length))?(links_33711[i]):null));
}

if((i < links_33711.length)){
(links_33711[i] = x__$2);
} else {
links_33711.push(x__$2);
}
...
var i_33713 = (0);
while(true){
if((i_33713 <= self__.level)){
var links_33714 = (update[i_33713]).forward;
if((x__$1 === (((i_33713 < links_33714.length))?(links_33714[i_33713]):null))){
(links_33714[i_33713] = (x__$1.forward[i_33713]));

var G__33716 = (i_33713 + (1));
i_33713 = G__33716;
continue;
} else {
var G__33717 = (i_33713 + (1));
i_33713 = G__33717;
continue;
}
} else {
