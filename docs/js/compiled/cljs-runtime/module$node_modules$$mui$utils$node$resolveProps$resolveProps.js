shadow$provide.module$node_modules$$mui$utils$node$resolveProps$resolveProps = function(global, require, module, exports) {
  function resolveProps(defaultProps, props) {
    ...
    Object.keys(defaultProps).forEach(propName => {
      if (propName.toString().match(/^(components|slots)$/)) {
        ...
        output[propName] = {};
        slotProps && Object.keys(slotProps) ? defaultSlotProps && Object.keys(defaultSlotProps) ? (output[propName] = (0,_extends2.default)({}, slotProps), Object.keys(defaultSlotProps).forEach(slotPropName => {
...
//# sourceMappingURL=module$node_modules$$mui$utils$node$resolveProps$resolveProps.js.map
