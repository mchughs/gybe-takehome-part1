shadow$provide.module$node_modules$$mui$material$node$FormHelperText$FormHelperText = function(global, require, module, exports) {
  ...
  var _clsx = module(require("module$node_modules$clsx$dist$clsx")), _composeClasses = module(require("module$node_modules$$mui$utils$node$composeClasses$index")), _formControlState = module(require("module$node_modules$$mui$material$node$FormControl$formControlState")), _useFormControl = module(require("module$node_modules$$mui$material$node$FormControl$useFormControl")), _styled = module(require("module$node_modules$$mui$material$node$styles$styled")), _capitalize = module(require("module$node_modules$$mui$material$node$utils$capitalize")), 
  _formHelperTextClasses = _interopRequireWildcard(require("module$node_modules$$mui$material$node$FormHelperText$formHelperTextClasses")), _useThemeProps = module(require("module$node_modules$$mui$material$node$styles$useThemeProps")), _jsxRuntime = require("module$node_modules$react$jsx_runtime"), _span;
  const _excluded = "children className component disabled error filled focused margin required variant".split(" "), FormHelperTextRoot = (0,_styled.default)("p", {name:"MuiFormHelperText", slot:"Root", overridesResolver:(props, styles) => {
  ...
  require = React.forwardRef(function(inProps, ref) {
    ...
    muiFormControl = (0,_formControlState.default)({props, muiFormControl, states:"variant size disabled error filled focused required".split(" ")});
    ...
    const {classes, contained, size, disabled, error, filled, focused, required} = props;
    muiFormControl = {root:["root", disabled && "disabled", error && "error", size && `size${(0,_capitalize.default)(size)}`, contained && "contained", focused && "focused", filled && "filled", required && "required"]};
    muiFormControl = (0,_composeClasses.default)(muiFormControl, _formHelperTextClasses.getFormHelperTextUtilityClasses, classes);
    return (0,_jsxRuntime.jsx)(FormHelperTextRoot, (0,_extends2.default)({as:component, ownerState:props, className:(0,_clsx.default)(muiFormControl.root, className), ref}, inProps, {children:" " === children ? _span || (_span = (0,_jsxRuntime.jsx)("span", {className:"notranslate", children:"​"})) : children}));
  });
