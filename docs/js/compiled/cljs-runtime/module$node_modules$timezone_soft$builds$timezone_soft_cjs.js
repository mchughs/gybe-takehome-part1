shadow$provide.module$node_modules$timezone_soft$builds$timezone_soft_cjs = function(global, require, module, exports) {
  (function(global, factory) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = factory() : "function" === typeof define && define.amd ? define(factory) : (global = "undefined" !== typeof globalThis ? globalThis : global || self, global.timezoneSoft = factory());
  })(this, function() {
    const cache = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("").reduce(function(h, c, i) {
      h[c] = i;
      return h;
    }, {});
    var encoding = {toAlphaCode:function(n) {
      if (void 0 !== "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"[n]) {
        return "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"[n];
      }
      let places = 1;
      var range = 36;
      let s = "";
      for (; n >= range; n -= range, places++, range *= 36) {
      }
      for (; places--;) {
        range = n % 36, s = String.fromCharCode((10 > range ? 48 : 55) + range) + s, n = (n - range) / 36;
      }
      return s;
    }, fromAlphaCode:function(s) {
      if (void 0 !== cache[s]) {
        return cache[s];
      }
      let n = 0;
      var places = 1, range = 36;
      let pow = 1;
      for (; places < s.length; n += range, places++, range *= 36) {
      }
      for (places = s.length - 1; 0 <= places; places--, pow *= 36) {
        range = s.charCodeAt(places) - 48, 10 < range && (range -= 7), n += range * pow;
      }
      return n;
    }};
    const toArray = function(trie) {
      const all = [], crawl = (index$jscomp$0, pref) => {
        var node = trie.nodes[index$jscomp$0];
        "!" === node[0] && (all.push(pref), node = node.slice(1));
        node = node.split(/([A-Z0-9,]+)/g);
        for (let i = 0; i < node.length; i += 2) {
          var str = node[i], ref = node[i + 1];
          if (str) {
            if (str = pref + str, "," === ref || void 0 === ref) {
              all.push(str);
            } else {
              var JSCompiler_inline_result = trie;
              var index = index$jscomp$0;
              ref = encoding.fromAlphaCode(ref);
              JSCompiler_inline_result = ref < JSCompiler_inline_result.symCount ? JSCompiler_inline_result.syms[ref] : index + ref + 1 - JSCompiler_inline_result.symCount;
              crawl(JSCompiler_inline_result, str);
            }
          }
        }
      };
    ...
    "Samara", "n"], Saratov:["true¦balakovo,europe,izhevsk,sa0;m0ratov;ara,t", "Samara", "n"], Sofia:["true¦b2e0imt,plovdiv,sof4varna;astern european,et,urope0;! eastern;g2u0;lgar0rgas;ia;!r", "Eastern European", "n", "eu3"], Stockholm:["true¦brussels,c5europe4goeteborg,ma3paris,romance,s0;e1tockholm,we0;!d4;!t;drid,lmoe;! central;e1openhag0;en;ntral european,st,t", "Central European", "n", "eu2"], Tallinn:["true¦e0tallinn;astern european,e2st1urope0;! eastern;!onia;!t", "Eastern European", "n", 
    "eu3"], Tirane:["true¦al4brussels,c2europe1madrid,paris,romance,tiran0;a,e;! central;e0openhagen;ntral european,st,t;!b0;!ania", "Central European", "n", "eu2"], Ulyanovsk:["true¦europe,m0russian,st petersburg,ulyanovsk,volgograd 2;oscow0sk;! 0;time", "Moscow", "n"], Uzhgorod:["true¦e0ruthenia,uzhgorod;astern european,et,urope0;! eastern", "Eastern European", "n", "eu3"], Vienna:["true¦a4brussels,c1donaustadt,europe0favorit2graz,linz,madrid,paris,romance,vienna;! central;e1openhag0;en;ntral european,st,t;t,u0;stria,t", 
    "Central European", "n", "eu2"], Vilnius:["true¦e3k2l0vilnius;ithuania,t0;!u;aunas,laipeda;astern european,et,urope0;! eastern", "Eastern European", "n", "eu3"], Volgograd:["true¦europe,m2russian,st petersburg,vol0;gograd0t,zhskiy;! time;oscow,sk", "Moscow", "n"], Warsaw:["true¦bKcHeuropeGgCkAl8m7p4r3s2torun,w0zabrze;ars0rocl0;aw;osnowiec,zczec6;adIomanA;aris,l,o0raga poludnie;l0znD;!and;adrid,okot3;odz,ubl0;in;ato2iel3rak0;ow;d2li0;wi0;ce;ansk,ynia;! central;e0openhagen,zestochowa;ntral europe0st,t;an;i2russels,y0;dgoszcz,t0;om;alystok,elsko biala", 
    "Central European", "n", "eu2"], Zaporozhye:["true¦e3luhansk2sevastopol,zapor0;izhia lugansk,ozh0;'ye,ye;! east;astern european,et,urope0;! eastern", "Eastern European", "n", "eu3"], Zurich:["true¦brussels,c4europe2geneve,li0madrid,paris,romance,swiss time,zurich;!e0;!chtenstein;! central,/0;busin1vaduz;e1openha0;gen;ntral european,st,t", "Central European", "n", "eu2"]}, Indian:{Chagos:["true¦british indian ocean territory,c4i0;ndian1o0;!t;! 0;c0ocean;hagos", "Indian Ocean", "n"], Christmas:["true¦c0indian;hristmas1x0;!r,t;! island", 
    "Christmas Island", "s"], Cocos:["true¦c0indian;c2ocos0;! island0;!s;!k,t", "Cocos Islands", "n"], Kerguelen:["true¦a5french southern2indian,kerguelen1tf0;!t;!st paul4;! 0;\x26 antarctic time,and antarctic0;! lands;msterdam0tf; island", "French Southern \x26 Antarctic", "s"], Mahe:["true¦indian,mahe,s0;c0eychelles,yc;!t", "Seychelles", "n"], Maldives:["true¦indian,m0;aldives,dv,v0;!t", "Maldives", "n"], Mauritius:["true¦indian,m0port louis;auritius,u0;!s,t", "Mauritius", "n"], Reunion:["true¦indian,r0;e0éu1;t,u0;nion", 
    "Réunion", "s"]}, Pacific:{Apia:["true¦apia,pacific,s2w0;est s1s0;!m,t;amoa", "West Samoa", "s"], Auckland:["true¦a2christchurch,manukau,n0pacific,wellington;ew zea2orth shore,z0;!dt,l,mt,st,t;ntarctica/1uck0;land;mcmurdo,south_pole", "New Zealand", "s", "nz"], Bougainville:["true¦bougainville,guinea2p0;a0gt;cific,pua new guinea;!n", "Papua New Guinea", "s"], Chatham:["true¦cha0nz-chat,pacific;dt,st,t0;!ham0;! 0;islands,time", "Chatham", "s", "chat"], Chuuk:["true¦chu2pacific0;!/0;truk,y2;t,uk0;!/truky0;ap", 
    "Chuuk", "n"], Easter:["true¦chile/easter4e0pacific;as0mt;st,t0;!er0;! 0;island", "Easter Island", "s", "east"], Efate:["true¦efate,pacific,v0;anuatu,u0;!t", "Vanuatu", "n"], Fakaofo:["true¦fakaofo,pacific,t0;k0okelau;!l,t", "Tokelau", "n"], Fiji:["true¦f0pacific;iji,j0;!i,st,t", "Fiji", "s", "fiji"], Funafuti:["true¦funafuti,pacific,t0;uv1v0;!t;!alu", "Tuvalu", "n"], Galapagos:["true¦co1gal0pacific;apagos,t,ápagos islands;lombia,st,t", "Colombia", "n"], Gambier:["true¦gam0pacific;bier0t;! islands", 
    "Gambier", "n"], Guadalcanal:["true¦guadalcanal,pacific,s0;b1lb,olomon0;! islands;!t", "Solomon Islands", "n"], Guam:["true¦ch5guam,m4northern mariana islands,p2west0; 0ern 0;pacific;acific0ort moresby;!/saipan;np,p;amorro,st", "Chamorro", "n"], Honolulu:["true¦aleutian4h1pacific0us/hawaii;!/johnston;a0onolulu,st;dt,st,t,waii0;! aleutian;! islands", "Hawaii-Aleutian", "n"], Kanton:["true¦kanton,p0;acific1ho0;enix islands,t;!/enderbury", "Phoenix Islands", "n"], Kiritimati:["true¦ki1lin0pacific;e islands,t;!r0;!i0;bati,timati0;! island", 
    "Line Islands", "n"], Kosrae:["true¦kos0pacific;rae,t", "Kosrae", "n"], Kwajalein:["true¦kwajalein,m0pacific;arshall islands,ht", "Marshall Islands", "n"], Majuro:["true¦m0pacific;a1h0;!l,t;juro,rshall islands", "Marshall Islands", "n"], Marquesas:["true¦mar0pacific;quesas0t;! islands", "Marquesas", "n"], Nauru:["true¦n0pacific;auru,r0;!t,u", "Nauru", "n"], Niue:["true¦n0pacific;iu1u0;!t;!e", "Niue", "n"], Norfolk:["true¦n0pacific;f1orfolk0;! island;!dt,k,t", "Norfolk Island", "n", "aus"], Noumea:["true¦n0pacific;c0ew caledonia,oumea;!l,t", 
    "New Caledonia", "n"], Pago_Pago:["true¦m5pa1s0us/sa4;a3st;cific0go_pago;!/0;m1sa0;moa;idway", "Samoa", "n"], Palau:["true¦p0;a1lw,w0;!t;cific,lau", "Palau", "n"], Pitcairn:["true¦p0;acific,cn,itcairn,n,st", "Pitcairn", "n"], Pohnpei:["true¦french polynesia,p0;acific1f,o0yf;hnpei0nt;!/ponape", "Ponape", "n"], Port_Moresby:["true¦antarctica/dumontd6dumont-d'6guinea5p0;a3g2ng,ort0; 0_0;moresby;!t;cific,pua new guinea;!n;urville", "Papua New Guinea", "s"], Rarotonga:["true¦c0pacific,rarotonga;k2o0;k,ok0;! islands;!t", 
    "Cook Islands", "n"], Tahiti:["true¦pacific,society islands,tah0;iti,t", "Tahiti", "n"], Tarawa:["true¦gil0pacific,tarawa;bert islands,t", "Gilbert Islands", "n"], Tongatapu:["true¦nuku'alofa,pacific,to0;!n0t;!ga0;!tapu", "Tonga", "s"], Wake:["true¦pacific,u2wak0;e0t;! island;m0s minor outlying islands;!i", "Wake Island", "n"], Wallis:["true¦pacific,w0;allis1f0lf;!t;! 0;\x260and0; futuna", "Wallis \x26 Futuna", "n"]}};
    let zones = {}, lexicon = Object.assign({}, {"gmt+0":["Etc/GMT"], "gmt-0":["Etc/GMT"], gmt0:["Etc/GMT"], "etc/gmt+0":["Etc/GMT"], "etc/gmt-0":["Etc/GMT"], "etc/gmt0":["Etc/GMT"], "msk+00":["Europe/Moscow"], "msk-01 - kaliningrad":["Europe/Kaliningrad"], "msk+00 - moscow area":["Europe/Moscow"], "msk+00 - crimea":["Europe/Kiev"], "msk+00 - volgograd":["Europe/Volgograd"], "msk+00 - kirov":["Europe/Kirov"], "msk+01 - astrakhan":["Europe/Astrakhan"], "msk+01 - saratov":["Europe/Saratov"], "msk+01 - ulyanovsk":["Europe/Ulyanovsk"], 
    "msk+01 - samaraudmurtia":["Europe/Samara"], "msk+02 - urals":["Asia/Yekaterinburg"], "msk+03":["Asia/Omsk"], "msk+04 - novosibirsk":["Asia/Novosibirsk"], "msk+04 - altai":["Asia/Barnaul"], "msk+04":["Asia/Tomsk"], "msk+04 - kemerovo":["Asia/Novokuznetsk"], "msk+04 - krasnoyarsk area":["Asia/Krasnoyarsk"], "msk+05 - irkutskburyatia":["Asia/Irkutsk"], "msk+06 - zabaykalsky":["Asia/Chita"], "msk+06 - lena river":["Asia/Yakutsk"], "msk+06 - tomponskyust-maysky":["Asia/Khandyga"], "msk+07 - amur river":["Asia/Vladivostok"], 
    "msk+07 - oymyakonsky":["Asia/Ust-Nera"], "msk+08 - magadan":["Asia/Magadan"], "msk+08 - sakhalin island":["Asia/Sakhalin"], "msk+08 - sakha (e) north kuril is":["Asia/Srednekolymsk"], "msk+09":["Asia/Kamchatka"], "msk+09 - bering sea":["Asia/Anadyr"], "russia time zone 11":["Asia/Anadyr"], "russia time zone 10":["Asia/Srednekolymsk"], "russia time zone 3":["Europe/Samara"], "coordinated universal time-09":["Pacific/Gambier"], "utc-09":["Pacific/Gambier"], "coordinated universal time-08":["Pacific/Pitcairn"]});
    Object.keys(pcked).forEach(top => {
      Object.keys(pcked[top]).forEach(name => {
        let [words, meta, hem, dst] = pcked[top][name], id = `${top}/${name}`;
        zones[id] = {meta, hem};
        name = Object.keys(unpack$1(words));
        name.forEach(k => {
          lexicon[k] = lexicon[k] || [];
          lexicon[k].push(id);
          k.match(/\//) && (k = k.split(/\//), k = k[k.length - 1].toLowerCase(), lexicon[k] = lexicon[k] || [], lexicon[k].push(id));
        });
        zones[id].wordCount = name.length;
        dst && (zones[id].dst = dstPatterns[dst].split(/\|/));
      });
    });
    (function(zones) {
      for (let i = 0; 14 >= i; i += 1) {
        zones[`Etc/GMT-${i}`] = {offset:i, meta:`gmt-${i}`, hem:"n"}, zones[`Etc/GMT+${i}`] = {offset:-1 * i, meta:`gmt+${i}`, hem:"n"};
      }
    })(zones);
    ...
    Object.keys(lexicon).forEach(k => {
      1 < lexicon[k].length && (lexicon[k] = unique(lexicon[k]), lexicon[k] = lexicon[k].sort((a, b) => zones[a].wordCount > zones[b].wordCount ? -1 : zones[a].wordCount < zones[b].wordCount ? 1 : 0));
    });
    var normalize = {one:str => {
      str = str.toLowerCase();
    ...
    const isOffset = /^([-+]?[0-9]+)h(r?s)?$/i, isNumber = /^([-+]?[0-9]+)$/, utcOffset = /utc([\-+]?[0-9]+)$/i, gmtOffset = /gmt([\-+]?[0-9]+)$/i, toIana = function(num) {
      num = Number(num);
      return -13 < num && 13 > num ? (num *= -1, "Etc/GMT" + ((0 < num ? "+" : "") + num)) : null;
    };
    var parseOffset$1 = function(tz) {
      ...
      return lexicon.hasOwnProperty(str) ? lexicon[str] : null;
    }, metas = {India:{std:["IST", 5.5], "long":"(UTC+05:30) Chennai, Kolkata, Mumbai, New Delhi"}, China:{std:["CST", 8], "long":"(UTC+08:00) Beijing, Chongqing, Hong Kong, Urumqi"}, "Central European":{std:["CET", 1], dst:["CEST", 2, "Central European Summer Time"], "long":"(UTC+01:00) Brussels, Copenhagen, Madrid, Paris"}, Atlantic:{dupe:!0, std:["AST", -4], dst:["ADT", -3], "long":"(UTC-04:00) Atlantic Time (Canada)"}, "Greenwich Mean":{std:["GMT", 0], "long":"(UTC) Coordinated Universal Time"}, 
    "Eastern European":{std:["EET", 2], dst:["EEST", 3, "Eastern European Summer Time"]}, Central:{dupe:!0, std:["CST", -6], dst:["CDT", -5], "long":"(UTC-06:00) Central Time (US \x26 Canada)"}, Eastern:{std:["EST", -5], dst:["EDT", -4], "long":"(UTC-05:00) Eastern Time (US \x26 Canada)"}, Argentina:{std:["ART", -3], "long":"(UTC-03:00) City of Buenos Aires"}, "East Africa":{std:["EAT", 3], "long":"(UTC+03:00) Nairobi"}, "West Africa":{std:["WAT", 1], "long":"(UTC+01:00) West Central Africa"}, Moscow:{std:["MSK", 
    3], "long":"(UTC+03:00) Moscow, St. Petersburg"}, Brasilia:{std:["BRT", -3], "long":"(UTC-03:00) Brasilia"}, Mountain:{std:["MST", -7], dst:["MDT", -6], "long":"(UTC-07:00) Mountain Time (US \x26 Canada)"}, "Central Africa":{std:["CAT", 2], "long":"(UTC+02:00) Windhoek"}, Arabian:{std:["AST", 3], "long":"(UTC+03:00) Kuwait, Riyadh"}, Alaska:{std:["AKST", -9], dst:["AKDT", -8], "long":"(UTC-09:00) Alaska"}, British:{std:["GMT", 0], dst:["BST", 1, "British Summer Time"], "long":"(UTC+00:00) Dublin, Edinburgh, Lisbon, London"}, 
    Irish:{std:["GMT", 0], dst:["IST", 1, "Irish Standard Time"]}, "West Kazakhstan":{std:["ALMT", 5], "long":"(UTC+05:00) Ashgabat, Tashkent"}, "Eastern Australia":{std:["AEST", 10], dst:["AEDT", 11, "Australian Eastern Daylight Time"], "long":"(UTC+10:00) Canberra, Melbourne, Sydney"}, "Western European":{std:["WET", 0], dst:["WEST", 1, "Western European Summer Time"]}, Indochina:{std:["ICT", 7], "long":"(UTC+07:00) Bangkok, Hanoi, Jakarta"}, "Central Mexico":{"long":"(UTC-06:00) Guadalajara, Mexico City, Monterrey", 
    std:["CST", -6], dst:["CDT", -5, "Central Daylight Time"]}, "South Africa":{std:["SAST", 2], "long":"(UTC+02:00) Harare, Pretoria"}, Krasnoyarsk:{std:["KRAT", 7], "long":"(UTC+07:00) Krasnoyarsk"}, Yakutsk:{std:["YAKT", 9], "long":"(UTC+09:00) Yakutsk"}, Pacific:{std:["PST", -8], dst:["PDT", -7], "long":"(UTC-08:00) Pacific Time (US \x26 Canada)"}, Amazon:{std:["AMT", -4], "long":"(UTC-04:00) Cuiaba"}, "Morocco Standard":{offset:1, "long":"(UTC+00:00) Casablanca", std:["WET", 1], dst:["WEST", 
    0, "Western European Summer Time"]}, Gulf:{std:["GST", 4], "long":"(UTC+04:00) Abu Dhabi, Muscat"}, Samara:{std:["SAMT", 4], "long":"(UTC+04:00) Izhevsk, Samara"}, Uzbekistan:{std:["UZT", 5]}, "East Kazakhstan":{std:["ALMT", 6], "long":"(UTC+06:00) Astana"}, Omsk:{std:["OMST", 6], "long":"(UTC+06:00) Omsk"}, "Western Indonesia":{std:["WIB", 7]}, Ulaanbaatar:{std:["ULAT", 8], "long":"(UTC+08:00) Ulaanbaatar"}, Malaysia:{std:["MYT", 8]}, Korean:{std:["KST", 9], "long":"(UTC+09:00) Seoul"}, "Central Australia":{std:["ACST", 
    9.5], dst:["ACDT", 10.5, "Australian Central Daylight Time"], "long":"(UTC+09:30) Adelaide"}, Brisbane:{dupe:!0, std:["AEST", 10]}, Vladivostok:{std:["VLAT", 10], "long":"(UTC+10:00) Vladivostok"}, Chamorro:{std:["ChST", 10], "long":"(UTC+10:00) Guam, Port Moresby"}, "Papua New Guinea":{std:["PGT", 11]}, "New Zealand":{std:["NZST", 12], dst:["NZDT", 13], "long":"(UTC+12:00) Auckland, Wellington"}, "Marshall Islands":{std:["MHT", 12]}, Samoa:{std:["SST", -11], "long":"(UTC+13:00) Samoa"}, "Hawaii-Aleutian":{std:["HAST", 
    -9], dst:["HADT", -8], "long":"(UTC-09:00) Aleutian Islands"}, "Mexican Pacific":{std:["HNPMX", -7], dst:["HEPMX", -6], "long":"(UTC-07:00) Chihuahua, La Paz, Mazatlan"}, Colombia:{std:["COT", -5]}, Acre:{std:["ACT", -5]}, Chile:{dupe:!0, std:["CLT", -3], dst:["CLST", -4, "Chile Summer Time"]}, Troll:{dupe:!0, std:["GMT", 0]}, "East Greenland":{std:["HNEG", 0], dst:["HEEG", 1, "East Greenland Summer Time"]}, Israel:{std:["IST", 2], dst:["IDT", 3], "long":"(UTC+02:00) Jerusalem"}, Syowa:{std:["SYOT", 
    3]}, Turkey:{std:["TRT", 3], "long":"(UTC+03:00) Istanbul"}, Iran:{std:["IRST", 3.5], dst:["IRDT", 4.5], "long":"(UTC+03:30) Tehran"}, Azerbaijan:{std:["AZT", 4], "long":"(UTC+04:00) Baku"}, Georgia:{std:["GET", 4], "long":"(UTC+04:00) Tbilisi"}, Armenia:{std:["AMT", 4], "long":"(UTC+04:00) Yerevan"}, Seychelles:{std:["SCT", 4]}, Mauritius:{std:["MUT", 4], "long":"(UTC+04:00) Port Louis"}, "Réunion":{std:["RET", 4]}, Afghanistan:{std:["AFT", 4.5], "long":"(UTC+04:30) Kabul"}, Mawson:{std:["MAWT", 
    5]}, Turkmenistan:{std:["TMT", 5]}, Tajikistan:{std:["TJT", 5]}, Pakistan:{std:["PKT", 5], "long":"(UTC+05:00) Islamabad, Karachi"}, Yekaterinburg:{std:["YEKT", 5], "long":"(UTC+05:00) Ekaterinburg"}, "French Southern \x26 Antarctic":{std:["TFT", 5]}, Maldives:{std:["MVT", 5]}, Nepal:{std:["NPT", 5.75], "long":"(UTC+05:45) Kathmandu"}, Vostok:{std:["MSK+4", 6]}, Kyrgyzstan:{std:["KGT", 6]}, Bangladesh:{std:["BST", 6], "long":"(UTC+06:00) Dhaka"}, Bhutan:{std:["BT", 6]}, "Indian Ocean":{std:["IOT", 
    6]}, Myanmar:{std:["MMT", 6.5], "long":"(UTC+06:30) Yangon (Rangoon)"}, "Cocos Islands":{std:["CCT", 6.5]}, Davis:{std:["DAVT", 7]}, Hovd:{std:["HOVT", 7], "long":"(UTC+07:00) Hovd"}, Novosibirsk:{std:["NOVT", 7], "long":"(UTC+07:00) Novosibirsk"}, "Christmas Island":{std:["CXT", 7]}, "Brunei Darussalam":{std:["BNT", 8]}, "Hong Kong":{std:["HKT", 8]}, Irkutsk:{std:["IRKT", 8], "long":"(UTC+08:00) Irkutsk"}, "Central Indonesia":{std:["WITA", 8]}, Philippine:{std:["PHST", 8]}, Singapore:{std:["SGT", 
    8], "long":"(UTC+08:00) Kuala Lumpur, Singapore"}, Taipei:{std:["CST", 8], "long":"(UTC+08:00) Taipei"}, "Western Australia":{std:["AWST", 8], "long":"(UTC+08:00) Perth"}, "Australian Central Western":{std:["ACWST", 8.75], "long":"(UTC+08:45) Eucla"}, "East Timor":{std:["TLT", 9]}, "Eastern Indonesia":{std:["WIT", 9]}, Japan:{std:["JST", 9], "long":"(UTC+09:00) Osaka, Sapporo, Tokyo"}, Palau:{std:["PWT", 9]}, "Australian Central":{dupe:!0, std:["ACST", 9.5]}, "Dumont-d’Urville":{std:["CLST", 
    10]}, Chuuk:{std:["CHUT", 10]}, "Lord Howe":{std:["LHST", 10.5], dst:["LHDT", 11.5], "long":"(UTC+10:30) Lord Howe Island"}, Casey:{std:["CAST", 11], dst:["CAST", 8, "Casey Summer Time"]}, Magadan:{std:["MAGT", 11], "long":"(UTC+11:00) Magadan"}, Sakhalin:{std:["SAKT", 11], "long":"(UTC+11:00) Sakhalin"}, Srednekolymsk:{std:["SRET", 11], "long":"(UTC+11:00) Chokurdakh"}, Vanuatu:{std:["VUT", 11]}, "Solomon Islands":{std:["SBT", 11]}, Kosrae:{std:["KOST", 11]}, "New Caledonia":{std:["NCT", 11]}, 
    Ponape:{std:["PONT", 11]}, Anadyr:{std:["ANAT", 12], "long":"(UTC+12:00) Anadyr, Petropavlovsk-Kamchatsky"}, "Petropavlovsk-Kamchatski":{std:["PETT", 12], "long":"(UTC+12:00) Anadyr, Petropavlovsk-Kamchatsky"}, Fiji:{std:["FJT", 12], dst:["FJT", 13, "Fiji Summer Time"], "long":"(UTC+12:00) Fiji"}, Tuvalu:{std:["TVT", 12]}, Nauru:{std:["NRT", 12]}, "Norfolk Island":{std:["NFT", 12], dst:["NFDT", 11], "long":"(UTC+11:00) Norfolk Island"}, "Gilbert Islands":{std:["GILT", 12]}, "Wake Island":{std:["WAKT", 
    12]}, "Wallis \x26 Futuna":{std:["WFT", 12]}, Chatham:{std:["CHAST", 12.75], dst:["CHADT", 13.75], "long":"(UTC+12:45) Chatham Islands"}, "West Samoa":{std:["WST", 13], dst:["WST", 14, "West Samoa Summer Time"]}, "Phoenix Islands":{std:["PHOT", 13]}, Tokelau:{std:["TKT", 13]}, Tonga:{std:["TOT", 13], "long":"(UTC+13:00) Nuku'alofa"}, "Line Islands":{std:["LINT", 14], "long":"(UTC+14:00) Kiritimati Island"}, Niue:{std:["NUT", -11]}, "Cook Islands":{std:["CKT", -10]}, Tahiti:{std:["TAHT", -10]}, 
    Marquesas:{std:["MART", -9.5], "long":"(UTC-09:30) Marquesas Islands"}, "Aleutian Standard":{iso:"(UTC-10:00) Aleutian Islands", std:["HST", -10], dst:["HDT", -9, "Hawaii Daylight Time"]}, Gambier:{std:["GAMT", -9], "long":"(UTC-09:00) Coordinated Universal Time-09"}, Pitcairn:{std:["PST", -8], "long":"(UTC-08:00) Coordinated Universal Time-08"}, "Northwest Mexico":{std:["HNNOMX", -6], dst:["HENOMX", -5], "long":"(UTC-08:00) Baja California"}, "Easter Island":{std:["EAST", -6], dst:["EASST", 
    -5, "Easter Island Summer Time"], "long":"(UTC-06:00) Easter Island"}, Ecuador:{std:["ECT", -5]}, Cuba:{std:["HNCU", -5], dst:["HECU", -4], "long":"(UTC-05:00) Havana"}, Peru:{std:["PET", -5]}, Paraguay:{std:["PYT", -4], dst:["PYST", -3, "Paraguay Summer Time"], "long":"(UTC-04:00) Asuncion"}, Venezuela:{std:["VET", -4], "long":"(UTC-04:00) Caracas"}, Guyana:{std:["GYT", -4]}, Bolivia:{std:["BOT", -4]}, Newfoundland:{std:["HNTN", -3.5], dst:["HETN", -2.5], "long":"(UTC-03:30) Newfoundland"}, 
    "French Guiana":{std:["GFT", -3]}, "West Greenland":{std:["WGT", -3], dst:["WGST", -2, "West Greenland Summer Time"], "long":"(UTC-03:00) Greenland"}, "St. Pierre \x26 Miquelon":{std:["HNPM", -3], dst:["HEPM", -2], "long":"(UTC-03:00) Saint Pierre and Miquelon"}, Uruguay:{std:["UYT", -3], "long":"(UTC-03:00) Montevideo"}, Suriname:{std:["SRT", -3]}, "Falkland Islands":{std:["FKST", -3]}, "Fernando de Noronha":{std:["FNT", -2]}, "South Georgia":{std:["GST", -2]}, Azores:{std:["AZOT", -1], dst:["AZOST", 
    0, "Azores Summer Time"], "long":"(UTC-01:00) Azores"}, "Cape Verde":{std:["CVT", -1], "long":"(UTC-01:00) Cabo Verde Is."}};
    for (var i = 0; 14 >= i; i += 1) {
      metas[`gmt-${i}`] = {name:`Etc/GMT-${i}`, std:[`GMT-${i}`, i], long:`(UTC-${i}:00) Coordinated Universal Time`}, metas[`gmt+${i}`] = {name:`Etc/GMT+${i}`, std:[`GMT+${i}`, -i], long:`(UTC+${i}:00) Coordinated Universal Time`};
    }
    i = function(str) {
      str = find$1(str) || [];
      "string" === typeof str && (str = [str]);
      return str = str.map(id => {
        if (id) {
          if (zones[id]) {
            var metaName = zones[id].meta;
            metas[metaName] || console.error(`missing tz-meta ${metaName}`);
            var meta = metas[metaName] || {}, dst = null;
            if (zones[id].dst && meta.dst) {
              let [abbr, offset, name] = meta.dst, [start, end] = zones[id].dst || [];
              dst = {abbr, offset, name:name || `${metaName} Daylight Time`, start, end};
            }
            var [abbr, offset] = meta.std, name = meta.name || `${metaName} Time`;
            id = {name, iana:id, standard:{abbr, offset, name:meta.name || `${metaName} Standard Time`}, daylight:dst || null, long:meta.long || `(UTC+${offset}:00) ${name}`};
          } else {
            console.error(`missing id ${id}`), id = null;
          }
        } else {
          id = null;
        }
    ...
    i.prototype.version = "1.5.2";
    return i;
  });
};

//# sourceMappingURL=module$node_modules$timezone_soft$builds$timezone_soft_cjs.js.map
