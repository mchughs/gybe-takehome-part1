...
var len__5726__auto___29412 = arguments.length;
var i__5727__auto___29413 = (0);
while(true){
if((i__5727__auto___29413 < len__5726__auto___29412)){
args__5732__auto__.push((arguments[i__5727__auto___29413]));

var G__29416 = (i__5727__auto___29413 + (1));
i__5727__auto___29413 = G__29416;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29292){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29293,G__29294,seq29292__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29342_SHARP_){
return (!((cljs.core.meta(p1__29342_SHARP_) == null)));
})))){
...
}catch (e29379){var _e__28680__auto__ = e29379;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e29381){var _e__28680__auto__ = e29381;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29389 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29391 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29391);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29393__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29389);
}});
...
var temp__5802__auto___29434 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___29434)){
var managed_print_level_29435 = temp__5802__auto___29434;
var _STAR_print_level_STAR__orig_val__29395_29436 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29396_29437 = managed_print_level_29435;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29396_29437);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29394_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29394_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29395_29436);
}} else {
job_fn();
}
