...
var o28947 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28947["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28949 = temp__5802__auto____$1;
return (o28949["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28644__auto__ = f;
return (o__28644__auto__["toString"]).call(o__28644__auto__);
} else {
return "";
}
}catch (e28955){var _ = e28955;
return "";
}});
...
try{var o__28644__auto___29232 = t;
(o__28644__auto___29232["cljs$lang$ctorPrWriter"]).call(o__28644__auto___29232,t,writer);
}catch (e28969){var __29233 = e28969;
}
...
var char_code = (function (){var o__28644__auto__ = (new String(char$));
return (o__28644__auto__["charCodeAt"]).call(o__28644__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28644__auto__ = String;
return (o__28644__auto__["fromCharCode"]).call(o__28644__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28990 = num_code;
switch (G__28990) {
case (1):
return (185);
...
var o__28644__auto__ = String;
return (o__28644__auto__["fromCharCode"]).call(o__28644__auto__,superscript_code);
});
/**
...
}catch (e28994){var _e__28680__auto__ = e28994;
return false;
}})())){
...
var vec__28995 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28995,(0),null);
...
var len__5726__auto___29252 = arguments.length;
var i__5727__auto___29253 = (0);
while(true){
if((i__5727__auto___29253 < len__5726__auto___29252)){
args__5732__auto__.push((arguments[i__5727__auto___29253]));

var G__29254 = (i__5727__auto___29253 + (1));
i__5727__auto___29253 = G__29254;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29022){
var vec__29023 = p__29022;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29023,(0),null);
...
var G__29276 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29277 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29276;
remaining_tokens = G__29277;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29017){
var G__29018 = cljs.core.first(seq29017);
var seq29017__$1 = cljs.core.next(seq29017);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29018,seq29017__$1);
}));
...
var vec__29049 = cljs.core.split_with((function (p1__29048_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29048_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29049,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29049,(1),null);
...
var vec__29059 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29059,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29059,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29280 = cljs.core.rest(remaining_tokens);
var G__29281 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29280;
name_tokens = G__29281;
continue;
} else {
...
var vec__29069 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29069,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29069,(1),null);
var vec__29072 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29072,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29072,(1),null);
var vec__29075 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29075,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29075,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29075,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29075,(3),null);
...
var vec__29088 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29088,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__29095 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29095,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29095,(1),null);
var vec__29098 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29098,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29098,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29104 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29104) : devtools.munging.parse_fn_info_deep.call(null,G__29104));
})()));
}
} else {
return fn_info;
...
var G__29300 = (arity + (1));
var G__29301 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29127){
var vec__29128 = p__29127;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29128,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29128,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29132_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29132_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29133_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29133_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___29308 = arguments.length;
var i__5727__auto___29309 = (0);
while(true){
if((i__5727__auto___29309 < len__5726__auto___29308)){
args__5732__auto__.push((arguments[i__5727__auto___29309]));

var G__29311 = (i__5727__auto___29309 + (1));
i__5727__auto___29309 = G__29311;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29140){
var vec__29141 = p__29140;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29141,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29135){
var G__29136 = cljs.core.first(seq29135);
var seq29135__$1 = cljs.core.next(seq29135);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29136,seq29135__$1);
}));
...
var map__29167 = options;
var map__29167__$1 = cljs.core.__destructure_map(map__29167);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29167__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29167__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29167__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29167__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29168 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29168,(5),null);
...
var o__28644__auto__ = f;
return (o__28644__auto__["getBasis"]).call(o__28644__auto__);
});
/**
...
}catch (e29180){var _e__28680__auto__ = e29180;
...
var G__29324 = (obj[cljs.core.first(path)]);
var G__29325 = cljs.core.rest(path);
obj = G__29324;
path = G__29325;
continue;
} else {
...
var _STAR_ = (function (accum,p__29209){
var vec__29210 = p__29209;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29210,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29210,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29219){
var vec__29220 = p__29219;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29220,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29220,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29220,(2),null);
...
var post_process = (function (p__29224){
var vec__29225 = p__29224;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29225,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29225,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29223_SHARP_){
return (obj[cljs.core.first(p1__29223_SHARP_)]);
}),sorted_matches);
