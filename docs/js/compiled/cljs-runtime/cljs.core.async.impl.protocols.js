...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32022 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_32022(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32023 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_32023(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32026 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_32026(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32027 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_32027(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32028 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_32028(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32031 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_32031(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_32036 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_32036(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32037 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_32037(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32038 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_32038(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32039 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_32039(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32040 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_32040(b);
}
});
