...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38980 = c;
var G__38980__$1 = (((G__38980 == null))?null:G__38980.prototype);
if((G__38980__$1 == null)){
return null;
} else {
return G__38980__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38984 = c;
var G__38984__$1 = (((G__38984 == null))?null:G__38984.prototype);
if((G__38984__$1 == null)){
return null;
} else {
return G__38984__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__39012 = c;
var G__39012__$1 = (((G__39012 == null))?null:G__39012.constructor);
if((G__39012__$1 == null)){
return null;
} else {
return G__39012__$1.displayName;
}
})();
...
var G__39013 = c;
var G__39013__$1 = (((G__39013 == null))?null:G__39013.constructor);
if((G__39013__$1 == null)){
return null;
} else {
return G__39013__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__39019 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39020 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39020);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39019);
}});
...
var c = this;
var G__39034_39186 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__39034_39186 == null)){
} else {
reagent.ratom.dispose_BANG_(G__39034_39186);
}
...
var renders_39190 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_39191 = cljs.core.first(cljs.core.vals(renders_39190));
...
if((cljs.core.count(renders_39190) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_39190))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_39191)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_39191], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__39086 = o;
reagent.impl.component.goog$module$goog$object.set(G__39086,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__39139 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__39140 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__39140);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__39139);
}});
...
var vec__39148 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39148,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39148,(1),null);
...
var G__39152 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__39152 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__39152);
}
});
}),[]);
