...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33810 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33810(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33811 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33811(runtime,key,spec);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33813 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33813(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33823 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33823(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33826 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33826(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33806,callback){
var map__33807 = p__33806;
var map__33807__$1 = cljs.core.__destructure_map(map__33807);
var input = map__33807__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33807__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33807__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
